...
.. code-block:: julia
  ...
  Operatorsaddsublatticeimbalance!(hops, lat, 0.1)
  Operatorsaddhaldane!(hops, lat, 0.2; spinhalf=true)
  Operatorsadd_spinorbit!(hops, lat, 0.03)
  Operatorsaddrashba!(hops, lat, 0.2)
  Operatorsadd_transversepotential!(hops, lat, 0.1)
  Operatorsadd_zeeman!(hops, lat, [0.0,0.0,0.1])
...
.. code-block:: julia
  ...
  valleyhops = Operatorsget_haldane_hops(lat, √3/9; spinhalf=true, mode=:sublatticeA)
  Operatorsaddhaldane!(valleyhops, lat, -√3/9; spinhalf=true, mode=:sublatticeB)
