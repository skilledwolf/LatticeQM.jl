...
ρ_sol, ϵ_GS, HMF, converged, error = Meanfield.solvehartreefock(
    H, v, ρ_init, 0.75; klin=30, iterations=800, tol=1e-7,# p_norm=Inf,
...
plot!(p1, title="Δ=1.5, non-interacting")
plot!(p2, title="Δ=1.5, Hubbard meanfield")
plot(p1,p2, titlefont=font(8))

mkpath("output"); savefig("output/hubbardmeanfield_example2.pdf")