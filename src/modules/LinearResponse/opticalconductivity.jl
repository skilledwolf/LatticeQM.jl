...
function opticalconductivity(frequencies::AbstractVector, i::Int, j::Int, H::AnyHops, lat::Lattice, args...; kwargs...)
    ...
    opticalconductivity(frequencies, H, J[i], J2[j], args...; kwargs...)
end
...
function opticalconductivity(frequencies::AbstractVector, H, J1, J2; klin, kwargs...)
    ...
    opticalconductivity(frequencies, H, J1, J2, ks; kwargs...)
end
...
function opticalconductivity(frequencies::AbstractVector, H, J1::Function, J2::Function, ks; μ::Float64=0.0, Γ::Float64=0.025, T::Float64=0.1, kwargs...)
