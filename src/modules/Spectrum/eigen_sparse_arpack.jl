import Arpack
eigmax_sparse(H::AbstractMatrix; kwargs...) = Arpack.eigs(Hermitian(H); nev=1, which=:LR, kwargs...)[1][1] |> real
eigmin_sparse(H::AbstractMatrix; kwargs...) = Arpack.eigs(Hermitian(H); nev=1, which=:SR, kwargs...)[1][1] |> real
